<template>
    <!--begin::Input-->
    <select ref="select" class="form-select text-dark input-navigation-select">
        <option value="header">{{ $t('header') }}</option>
        <option value="top-bar">{{ $t('top-bar') }}</option>
        <option value="footer">{{ $t('footer') }}</option>
        <option value="footer-section-1">{{ $t('footer-section-1') }}</option>
        <option value="footer-section-2">{{ $t('footer-section-2') }}</option>
        <option value="footer-section-3">{{ $t('footer-section-3') }}</option>
        <option value="footer-section-4">{{ $t('footer-section-4') }}</option>
    </select>
    <!--end::Input-->
</template>
...
export default {
    name: "InputNavigationPlaceSelect",
    props: {
        modelValue: {
