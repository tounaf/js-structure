                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">{{ $t('level') }}</th>
                                <th class="min-w-125px">{{ $t('sub_level') }}</th>
                            ...
                            <tr
                                ...
                                <!--begin::Name=-->
                                <td>
                                    <router-link :to="{name: 'admin.packages.view', params:{id: model.id}}" class="d-flex align-items-center">
                                ...
                                <!--begin::Level=-->
                                <td>
                                    <span class="text-dark text-hover-primary fs-6">{{ model.level }}</span>
                                </td>
                                <!--end::Level=-->
                                <!--begin::SubLevel=-->
                                <td>
                                    <span class="text-dark text-hover-primary fs-6">{{ model.sub_level }}</span>
                                </td>
                                <!--end::SubLevel=-->
                                <!--begin::Versions count=-->
                                <td>
                                    <router-link :to="{name: 'admin.packages.view', params:{id: model.id}}" class="text-dark text-hover-primary fs-6">{{ $tc('count.versions', model.versions_count) }}</router-link>
                                </td>
                                <!--end::Versions count=-->
                                <!--begin::Status=-->
                                <td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.packages.view', params: {id: model.id}}" class="menu-link px-3">{{ $t('view') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.packages.edit', params: {id: model.id}}" class="menu-link px-3">{{ $t('edit') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.packages.prices', params: {id: model.id}}" class="menu-link text-warning px-3">{{ $t('prices') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                            ...
                            <tr class="odd">
                                <td colspan="8">{{ $t('no_package_found') }}</td>
                            </tr>
                            </tbody>
                            <!--end::Table body-->
                        </table>
    ...
    export default {
        ...
        setup(){
            ...
            const loadModels = () => {
                ...
                ApiService.get('/packages', {params: query}, true)
                    .then(({data}) => {
                        if(data.success) {
            ...
            const handleDelete = (model) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ApiService.delete('/packages/' + model.id)
                            .then(response => {
            ...
            const handleMassDelete = () => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        ApiService.delete('/packages', {data: {packages: data}})
                            .then(response => {
                                if(response.data.success){
