<template>
    ...
    <div v-if="model" class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <ToolBar>
            <!--begin::Buttons-->
            <router-link :to="{name: 'admin.packages.edit'}" class="btn btn-sm btn-flex btn-primary fw-bolder me-2">{{ $t('edit') }}</router-link>
            <!--end::Buttons-->
        </ToolBar>
        <!--end::Toolbar-->
                ...
                <div class="card mb-6 mb-xl-9">
                    <div class="card-body pt-9 pb-0">
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div v-if="model.name" class="d-flex align-items-center mb-1">
                                            <router-link :to="{name:'admin.packages.view' }" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-3">{{ model.name }}</router-link>
                                        </div>
                                        <!--end::Status-->
                                    </div>
                                    <!--end::Details-->
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <router-link :to="{name:'admin.packages.view'}" :class="{'active': isActive('admin.packages.view')}" class="nav-link text-active-primary py-5 me-6">{{ $t('versions') }}</router-link>
                            </li>
                            <!--end::Nav item-->
                        </ul>
                        <!--end::Nav-->
