                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="w-100 mw-250px">
                                <InputAjaxSelect url="/api/v1/admin/point-of-sales" name="publisher" :placeholder="$t('messages.select.point_of_sale')" class="mb-0" v-model="pointOfSale" :rules="{}" />
                            </div>
                            <!--end::POF-->
                            <!--begin::Status-->
                            <div class="w-100 mw-250px">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <tr
                                ...
                                <!--begin::Name=-->
                                <td>
                                    <router-link :to="{name: 'admin.categories.view', params:{id: model.id}}" class="d-flex align-items-center">
                                ...
                                <td>
                                    <router-link :to="{name: 'admin.categories.view', params:{id: model.id}}" class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <span class="text-dark fw-bolder text-hover-primary fs-6">{{ model.slug }}</span>
                                        </div>
                                    </router-link>
                                </td>
                                <!--end::Slug=-->
                                ...
                                <td>
                                    <router-link :to="{name: 'admin.categories.view', params:{id: model.id}}" class="text-dark text-hover-primary fs-6">{{ $tc('count.versions', model.versions_count) }}</router-link>
                                </td>
                                <!--end::Versions count=-->
                                <!--begin::Status=-->
                                <td>
                                ...
                                <!--begin::Category main=-->
                                <td>
                                    <router-link v-if="model.main" :to="{name: 'admin.categories.view', params:{id: model.main.id}}" class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <span class="text-dark fw-bolder text-hover-primary fs-6">{{ model.main.name }}</span>
                                        </div>
                                    </router-link>
                                </td>
                                <!--end::Category main=-->
                                <!--begin::POF=-->
                                <td>
                                    <router-link v-if="model.point_of_sale" :to="{name: 'admin.point-of-sales.view', params:{id: model.point_of_sale.id}}" class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <span class="text-dark fw-bolder text-hover-primary fs-6">{{ model.point_of_sale.name }}</span>
                                        </div>
                                    </router-link>
                                </td>
                                <!--end::POF=-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.categories.view', params: {id: model.id}}" class="menu-link px-3">{{ $t('view') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.categories.edit', params: {id: model.id}}" class="menu-link px-3">{{ $t('edit') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                            ...
                            <tr class="odd">
                                <td colspan="9">{{ $t('no_category_found') }}</td>
                            </tr>
                            </tbody>
                            <!--end::Table body-->
                        </table>
        ...
        setup(){
            ...
            const params = computed(() => {
                ...
                if(pointOfSale.value){
                    data['point-of-sale'] = pointOfSale.value
                }
                if(status.value){
            ...
            const loadModels = () => {
                ...
                ApiService.get('/categories', {params: query}, true)
                    .then(({data}) => {
                        if(data.success) {
            ...
            const handleDelete = (model) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ApiService.delete('/categories/' + model.id)
                            .then(response => {
            ...
            const handleMassDelete = () => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        ApiService.delete('/categories', {data: {categories: data}})
                            .then(response => {
                                if(response.data.success){
