<template>
    ...
    <div v-if="model" class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <ToolBar>
            <!--begin::Buttons-->
            <router-link :to="{name: 'admin.categories.edit'}" class="btn btn-sm btn-flex btn-primary fw-bolder me-2">{{ $t('edit') }}</router-link>
            <!--end::Buttons-->
        </ToolBar>
        <!--end::Toolbar-->
        <!--begin::Post-->
                ...
                <div class="card mb-6 mb-xl-9">
                    <div class="card-body pt-9 pb-0">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <!--end::Name-->
                                        <!--begin::Point Of Sale-->
                                        <div v-if="model.point_of_sale" class="text-gray-400">
                                            {{ $t('point_of_sale') }}:
                                            <router-link :to="{name:'admin.point-of-sales.view', params:{id: model.point_of_sale.id}}">{{ model.point_of_sale.name }}</router-link>
                                        </div>
                                        <!--end::Point Of Sale-->
                                    </div>
                                    <!--end::Details-->
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                            <li class="nav-item">
                                <router-link :to="{name:'admin.categories.view'}" :class="{'active': isActive('admin.categories.view')}" class="nav-link text-active-primary py-5 me-6">{{ $t('versions') }}</router-link>
                            </li>
                        </ul>
                        <!--end::Nav-->
                    </div>
...
export default {
    ...
    setup(){
        ...
        const loadModel = () => {
            ApiService.get('/categories/' + route.params.id)
                .then(({data}) => {
                    if(data.success) {
