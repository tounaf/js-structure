        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <div class="w-100 mw-250px">
                    <InputAjaxSelect :url="`/api/v1/admin/categories/${$route.params.id}/titles`" name="title" :placeholder="$t('messages.select.title')" class="mb-0" v-model="title" :rules="{}" />
                </div>
                <!--end::Titles-->
...
export default {
    ...
    setup(){
        ...
        const loadModels = () => {
            ...
            ApiService.get('/categories/' +  route.params.id + '/versions', {params: query}, true)
                .then(({data}) => {
                    if(data.success) {
