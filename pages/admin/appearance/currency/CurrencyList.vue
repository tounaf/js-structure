<template>
    <div class="content d-flex flex-column flex-column-fluid vh-100" id="kt_content">
        ...
        <ToolBar>
            ...
            <router-link :to="{name: 'admin.currencies.create'}" class="btn btn-sm btn-flex btn-primary fw-bolder me-2">{{ $t('create') }}</router-link>
            <!--end::Button-->
        </ToolBar>
        <!--end::Toolbar-->
        <!--begin::Post-->
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="w-50px">{{ $t('order') }}</th>
                                <th class="min-w-125px">{{ $t('currency') }}</th>
                                <th class="min-w-125px">{{ $t('code') }}</th>
                                <th class="min-w-125px">{{ $t('default') }}</th>
                            ...
                            <tr
                                ...
                                <!--begin::Label=-->
                                <td>
                                    <router-link :to="{name: 'admin.currencies.view', params:{id: model.id}}" class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <span class="text-dark fw-bolder text-hover-primary fs-6">{{ model.label }}</span>
                                        </div>
                                    </router-link>
                                </td>
                                <!--end::Label=-->
                                ...
                                <td>
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <input
                                            ...
                                            :name="`models.${index}.is_default`"
                                            type="checkbox"
                                            v-model="models[index].is_default"
                                            @input="handleToggle(index, 'is_default', model)">
                                    </label>
                                </td>
                                <!--end::Default=-->
                                <!--begin::Active=-->
                                <td>
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <input
                                            ...
                                            type="checkbox"
                                            v-model="models[index].is_active"
                                            @input="handleToggle(index, 'is_active', model)">
                                    </label>
                                </td>
                                <!--end::Active=-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.currencies.view', params: {id: model.id}}" class="menu-link px-3">{{ $t('view') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.currencies.edit', params: {id: model.id}}" class="menu-link px-3">{{ $t('edit') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                            ...
                            <tr class="odd">
                                <td colspan="4">{{ $t('no_language_found') }}</td>
                            </tr>
                            </tbody>
                            <!--end::Table body-->
                        </table>
...
<script>
    ...
    export default {
        ...
        setup(){
            ...
            const handleDelete = (model) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ApiService.delete('/currencies/' + model.id)
                            .then(response => {
            ...
            const handleMassDelete = () => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        ApiService.delete('/currencies', {data: {currencies: data}})
                            .then(response => {
                                if(response.data.success){
            ...
            const handleToggle = (index, field, model) => {
                const data = {'field':field}
                ApiService.put('/currencies/' + model.id + '/toggle', data)
                    .then(response => {
                        if(!response.data.success){
                            models.value[index][field] = !models.value[index][field]
                        }
                    })
            }
