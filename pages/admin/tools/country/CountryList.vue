<template>
    <div class="content d-flex flex-column flex-column-fluid vh-100" id="kt_content">
        ...
        <ToolBar>
            ...
            <router-link :to="{name: 'admin.countries.create'}" class="btn btn-sm btn-flex btn-primary fw-bolder me-2">{{ $t('create') }}</router-link>
            <!--end::Button-->
        </ToolBar>
        <!--end::Toolbar-->
        <!--begin::Post-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.countries.edit', params: {id: model.id}}" class="menu-link px-3">{{ $t('edit') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
            ...
            const handleDelete = (model) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ApiService.delete('/countries/' + model.id)
                            .then(response => {
            ...
            const handleMassDelete = () => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        ApiService.delete('/countries', {data: {countries: data}})
                            .then(response => {
                                if(response.data.success){
