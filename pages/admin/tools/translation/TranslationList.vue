<template>
    <div class="content d-flex flex-column flex-column-fluid vh-100" id="kt_content">
        ...
        <ToolBar>
            ...
            <router-link :to="{name: 'admin.translations.create'}" class="btn btn-sm btn-flex btn-primary fw-bolder me-2">{{ $t('create') }}</router-link>
            <!--end::Button-->
        </ToolBar>
        <!--end::Toolbar-->
        <!--begin::Post-->
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.translations.view', params: {id: model.id}}" class="menu-link px-3">{{ $t('view') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.translations.edit', params: {id: model.id}}" class="menu-link px-3">{{ $t('edit') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                            ...
                            <tr class="odd">
                                <td colspan="6">{{ $t('no_translation_found') }}</td>
                            </tr>
                            </tbody>
                            <!--end::Table body-->
                        </table>
    ...
    export default {
        ...
        setup(){
            ...
            const loadModels = () => {
                ...
                ApiService.get('/translations', {params: query}, true)
                    .then(({data}) => {
                        if(data.success) {
            ...
            const handleDelete = (model) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ApiService.delete('/translations/' + model.id)
                            .then(response => {
            ...
            const handleMassDelete = () => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        ApiService.delete('/translations', {data: {translations: data}})
                            .then(response => {
                                if(response.data.success){
