<template>
    ...
    <div v-if="model" class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <ToolBar>
            <!--begin::Buttons-->
            <router-link :to="{name: 'admin.faq.categories.edit'}" class="btn btn-sm btn-flex btn-primary fw-bolder me-2">{{ $t('edit') }}</router-link>
            <!--end::Buttons-->
        </ToolBar>
        <!--end::Toolbar-->
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center mb-1">
                                            <a class="text-gray-800 text-hover-primary fs-2 fw-bolder me-3">{{ model.title }}</a>
                                        </div>
                                        <!--end::Name-->
                                    </div>
                                    <!--end::Details-->
    ...
    setup(){
        ...
        onMounted(() => {
            store.dispatch(SET_BREADCRUMB, [
                ...
                {title: 'categories', route: 'admin.faq.categories'},
                {title: 'Category'},
            ])
        })
        ...
        const loadModel = () => {
            ApiService.get('/faq/categories/' + route.params.id)
                .then(({data}) => {
                    if(data.success) {
