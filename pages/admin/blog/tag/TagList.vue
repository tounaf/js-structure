<template>
    <div class="content d-flex flex-column flex-column-fluid vh-100" id="kt_content">
        ...
        <ToolBar>
            ...
            <router-link :to="{name: 'admin.blog.tags.create'}" class="btn btn-sm btn-flex btn-primary fw-bolder me-2">{{ $t('create') }}</router-link>
            <!--end::Button-->
        </ToolBar>
        <!--end::Toolbar-->
        <!--begin::Post-->
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <tr
                                ...
                                <!--begin::Name=-->
                                <td>
                                    <router-link :to="{name: 'admin.blog.tags.view', params:{id: model.id}}" class="d-flex align-items-center">
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.blog.tags.view', params: {id: model.id}}" class="menu-link px-3">{{ $t('view') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.blog.tags.edit', params: {id: model.id}}" class="menu-link px-3">{{ $t('edit') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                            ...
                            <tr class="odd">
                                <td colspan="6">{{ $t('no_tag_found') }}</td>
                            </tr>
                            </tbody>
                            <!--end::Table body-->
                        </table>
    ...
    export default {
        ...
        setup(){
            ...
            const loadModels = () => {
                ...
                ApiService.get('/blog/tags', {params: query}, true)
                    .then(({data}) => {
                        if(data.success) {
            ...
            const handleDelete = (model) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ApiService.delete('/blog/tags/' + model.id)
                            .then(response => {
            ...
            const handleMassDelete = () => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        ApiService.delete('/blog/tags', {data: {tags: data}})
                            .then(response => {
                                if(response.data.success){
