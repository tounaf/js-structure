                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            >
                                ...
                                <tr :class="{'border-bottom-0': model.expanded}">
                                    ...
                                    <!--begin::Account=-->
                                    <td>
                                        <router-link v-if="model.account" :to="{name: 'admin.customers.view', params:{id: model.account.id}}" class="d-flex align-items-center">
                                            <div class="d-flex justify-content-start flex-column">
                                                <span class="text-dark fw-bolder text-hover-primary fs-6">{{ model.account.name }}</span>
                                            </div>
                                        </router-link>
                                    </td>
                                    <!--end::Account=-->
                                    ...
                                    <!--begin::Date=-->
                                    <td>
                                        <router-link :to="{name: 'admin.orders.view', params:{id: model.id}}">
                                            <span class="text-dark text-hover-primary">{{ $filters.formatDate(model.created_at) }}</span>
                                        </router-link>
                                    </td>
                                    <!--end::Date=-->
                                    <!--begin::External ID=-->
                                    ...
                                    <td class="text-end">
                                        ...
                                        <button v-if="model.subscriptions && model.subscriptions.length" @click="toggle(model)" type="button" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <router-link :to="{name: 'admin.orders.view', params: {id: model.id}}" class="menu-link px-3">{{ $t('view') }}</router-link>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                ...
                                <!--begin::Children-->
                                <SubscriptionList v-if="model.expanded" :models="model.subscriptions" />
                                <!--end::Children=-->
                            ...
                            <tr class="odd">
                                <td colspan="9">{{ $t('no_order_found') }}</td>
                            </tr>
                            </tbody>
                            <!--end::Table body-->
                        </table>
...
export default {
    ...
    setup(){
        ...
        const loadModels = () => {
            ...
            ApiService.get('/orders', {params: query}, true)
                .then(({data}) => {
                    if(data.success) {
        ...
        const handleDelete = (model) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ApiService.delete('/orders/' + model.id)
                        .then(response => {
        ...
        const handleMassDelete = () => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    ApiService.delete('/orders', {data: {orders: data}})
                        .then(response => {
                            if(response.data.success){
