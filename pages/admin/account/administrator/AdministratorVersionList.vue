    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <div class="w-100 mw-200px">
                    <InputAjaxSelect :url="`/api/v1/admin/administrator/${$route.params.id}/titles`" name="title" :placeholder="$t('messages.select.title')" class="mb-0" v-model="title" :rules="{}" />
                </div>
                <!--end::Titles-->
            </div>
            <!--end::Card toolbar-->
        ...
        <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5">
                ...
                <tr class="odd">
                    <td colspan="4">{{ $t('no_version_found') }}</td>
                </tr>
                </tbody>
                <!--end::Table body-->
            </table>
...
export default {
    ...
    setup(){
        ...
        const loadModels = () => {
            ...
            ApiService.get('/administrators/' + route.params.id + '/versions', {params: query}, true)
                .then(({data}) => {
                    if(data.success) {
