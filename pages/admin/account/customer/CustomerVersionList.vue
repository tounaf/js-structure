        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <div class="w-100 mw-200px">
                    <InputAjaxSelect :url="`/api/v1/admin/customers/${$route.params.id}/titles`" name="title" :placeholder="$t('messages.select.title')" class="mb-0" v-model="title" :rules="{}" />
                </div>
                <!--end::Titles-->
            </div>
            <!--end::Card toolbar-->
...
export default {
    ...
    setup(){
        ...
        const loadModels = () => {
            ...
            ApiService.get('/customers/' + route.params.id + '/versions', {params: query}, true)
                .then(({data}) => {
                    if(data.success) {
