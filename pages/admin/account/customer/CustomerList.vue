                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <tr
                                ...
                                <!--end::Checkbox-->
                                <td>
                                    <router-link :to="{name: 'admin.customers.view', params: {id: model.id}}" class="d-flex align-items-center">
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <router-link  v-if="model.id" :to="{name: 'admin.customers.view', params: {id: model.id}}" class="menu-link px-3">{{ $t('view') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <router-link  v-if="model.id" :to="{name: 'admin.customers.edit', params: {id: model.id}}" class="menu-link px-3">{{ $t('edit') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                            ...
                            <tr class="odd">
                                <td colspan="5">{{ $t('no_customer_found') }}</td>
                            </tr>
                            </tbody>
                            <!--end::Table body-->
                        </table>
...
export default {
    ...
    setup(){
        ...
        const loadModels = () => {
            ...
            ApiService.get('/customers', {params: query}, true)
                .then(({data}) => {
                    if(data.success) {
        ...
        const handleDelete = (model) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ApiService.delete('/customers/' + model.id)
                        .then(response => {
        ...
        const handleMassDelete = () => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (isContains) {
                        toastr.error(t("can_not_delete"))
                    } else {
                        ApiService.delete('/customers', {data: {customers: data}})
                            .then(response => {
                                if (response.data.success) {
