                ...
                <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="flex-lg-row-fluid ms-lg-15">
                        ...
                        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                            <!--begin:::Tab item-->
                            <li class="nav-item">
                                <router-link :to="{name: 'admin.customers.view'}" class="nav-link text-active-primary pb-4" :class="{'active': isActive('admin.customers.view')}">{{ $t('packages') }}</router-link>
                            </li>
                            <!--end:::Tab item-->
                            <!--begin:::Tab item-->
                            <li class="nav-item">
                                <router-link :to="{name: 'admin.customers.versions'}" class="nav-link text-active-primary pb-4" :class="{'active': isActive('admin.customers.versions')}">{{ $t('versions') }}</router-link>
                            </li>
                            <!--end:::Tab item-->
                        </ul>
                        <!--end:::Tabs-->
...
export default {
    ...
    setup(){
        ...
        const loadModel = () => {
            ApiService.get('/customers/' + route.params.id)
                .then(({data}) => {
                    if(data.success) {
