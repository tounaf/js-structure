                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th>{{ $t('slug') }}</th>
                                <th>{{ $t('last_issue') }}</th>
                                <th>{{ $t('issues_count') }}</th>
                                <th class="min-w-100px">{{ $t('status') }}</th>
                                <th>{{ $t('title') }}</th>
                                <th class="min-w-100px">{{ $t('external_id') }}</th>
                            ...
                            <!--end::Table head-->
                            <!--begin::Table body-->
                            <tbody v-if="models && models.length" class="fw-bold text-gray-600">
                            <tr
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.versions.edit', params: {id: model.id}}" class="menu-link px-3">{{ $t('edit') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.versions.prices', params: {id: model.id}}" class="menu-link text-warning px-3">{{ $t('prices') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
...
export default {
    ...
    setup(){
        ...
        const loadModels = () => {
            ...
            ApiService.get('/versions', {params: query}, true)
                .then(({data}) => {
                    if(data.success) {
