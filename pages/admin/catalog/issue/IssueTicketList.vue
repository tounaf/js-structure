        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <div class="w-100 mw-250px">
                    <select v-model="format" class="form-select form-select-solid" data-control="select2" data-hide-search="true" :data-placeholder="$t('format')">
                        <option :value="null">{{ $t('all') }}</option>
                        <option value="iosv3">iosv3</option>
                        <option value="html5-reader">html5-reader</option>
                    </select>
                </div>
                <!--end::Status-->
            </div>
        ...
        <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5">
                ...
                <tr
                    ...
                    <!--begin::Date=-->
                    <td>
                        <span>{{ $filters.formatDateTime(model.created_at) }}</span>
                    </td>
                    <!--end::Date=-->
                    <!--begin::Format=-->
                    <td>
                ...
                <tr class="odd">
                    <td colspan="7">{{ $t('no_ticket_found') }}</td>
                </tr>
                </tbody>
                <!--end::Table body-->
            </table>
...
export default {
    ...
    setup(){
        ...
        const loadModels = () => {
            ...
            ApiService.get('/issues/' + route.params.id + '/tickets', {params: query}, true)
                .then(({data}) => {
                    if(data.success) {
