        ...
        <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5">
                ...
                <tr
                    ...
                    <!--begin::Issue=-->
                    <td>
                         <router-link v-if="model.last_issue" :to="{name: 'admin.issues.view', params:{id: model.last_issue.id}}" class="text-dark text-hover-primary fs-6">{{ model.last_issue.name }} ({{ model.last_issue.date }}) </router-link>
                    </td>
                    <!--end::Issue=-->
                    <!--begin::Title=-->
                    <td>
                        <router-link v-if="model.title" :to="{name: 'admin.titles.view', params:{id: model.title.id}}" class="text-dark text-hover-primary fs-6">{{ model.title.name }}</router-link>
                    </td>
                    <!--end::Title=-->
                    <!--begin::Status=-->
                    <td>
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <router-link :to="{name: '', params: {id: model.id}}" class="menu-link px-3">{{ $t('view') }}</router-link>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                ...
                <tr class="odd">
                    <td colspan="7">{{ $t('no_version_found') }}</td>
                </tr>
                </tbody>
                <!--end::Table body-->
            </table>
    ...
    export default {
        ...
        setup(){
            ...
            const loadModels = () => {
                ...
                ApiService.get('/publishers/' + route.params.id + '/versions', {params: query}, true)
                    .then(({data}) => {
                        if(data.success) {
