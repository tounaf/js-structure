                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">{{ $t('categories_count') }}</th>
                            ...
                            <tr
                                ...
                                <!--begin::Slug=-->
                                <td>
                                    <router-link :to="{name: 'admin.point-of-sales.view', params:{id: model.id}}" class="d-flex align-items-center">
                                ...
                                <!--begin::Titles Count=-->
                                <td>
                                    <router-link :to="{name: 'admin.point-of-sales.view', params:{id: model.id}}" class="text-dark text-hover-primary fs-6">{{ $tc('count.categories', model.categories_count) }}</router-link>
                                </td>
                                <!--end::Titles Count=-->
                                <!--begin::External_ID=-->
                                <td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <router-link :to="{name: 'admin.point-of-sales.view', params: {id: model.id}}" class="menu-link px-3">{{ $t('view') }}</router-link>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                            ...
                            <tr class="odd">
                                <td colspan="6">{{ $t('no_point_of_sale_found') }}</td>
                            </tr>
                            </tbody>
                            <!--end::Table body-->
                        </table>
...
export default {
    ...
    setup(){
        ...
        const loadModels = () => {
            ...
            ApiService.get('/point-of-sales', {params: query}, true)
                .then(({data}) => {
                    if(data.success) {
        ...
        const handleDelete = (model) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ApiService.delete('/point-of-sales/' + model.id)
                        .then(response => {
        ...
        const handleMassDelete = () => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    ApiService.delete('/point-of-sales', {data: {point_of_sales: data}})
                        .then(response => {
                            if(response.data.success){
