                ...
                <div class="card mb-6 mb-xl-9">
                    <div class="card-body pt-9 pb-0">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="fs-4 fw-bolder">{{ model.categories_count }}</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-bold fs-6 text-gray-400">{{ $t('categories_count') }}</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                                        <!--begin::Stat-->
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                            <li class="nav-item">
                                <router-link :to="{name:'admin.point-of-sales.view'}" :class="{'active': isActive('admin.point-of-sales.view')}" class="nav-link text-active-primary py-5 me-6">{{ $t('categories') }}</router-link>
                            </li>
                        </ul>
                        <!--end::Nav-->
                    </div>
    ...
    setup(){
        ...
        onMounted(() => {
            store.dispatch(SET_BREADCRUMB, [
                ...
                {title: 'point_of_sales', route: 'admin.point-of-sales'},
                {title: 'point_of_sale'},
            ])
        })
        ...
        const loadModel = () => {
            ApiService.get('/point-of-sales/' + route.params.id)
                .then(({data}) => {
                    if(data.success) {
